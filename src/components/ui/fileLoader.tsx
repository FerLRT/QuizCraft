...
export function FileLoader({
  ...
  return (
    <div
      className={`flex w-full items-center justify-center border-[3px] rounded-lg bg-transparent hover:bg-neutral-800 ${
        dragActive
          ? invalidFileType
    ...
    >
      ...
      >
        <div className="flex flex-col items-center justify-center pb-6 pt-5">
          <svg
            className="mb-4 h-8 w-8 text-white dark:text-gray-400"
            aria-hidden="true"
          ...
          <p className="mb-2 text-sm text-white dark:text-gray-400 text-center max-w-xs mx-auto">
