    ...
    >
      ...
      >
        <div className="flex flex-col items-center justify-center pb-6 pt-5">
          ...
          <p className="mb-2 text-sm text-gray-500 dark:text-gray-400 text-center max-w-xs mx-auto">
            <span className="font-semibold">Click to upload</span> or drag and
            drop
          </p>
          <p className="text-xs text-gray-500 dark:text-gray-400 text-center max-w-xs mx-auto">
